    ...
    public function up(): void
    {
        Schema::create('potential_trade_routes', function (Blueprint $table) {
            ...
            $table->integer('purchase_price')
                ->nullable();
            $table->enum('supply_at_origin', SupplyLevels::values())
                ->nullable();
            $table->enum('activity_at_origin', ActivityLevels::values())
                ->nullable();
            $table->integer('trade_volume_at_origin')
                ->nullable();
            $table->integer('sell_price')
                ->nullable();
            $table->enum('supply_at_destination', SupplyLevels::values())
                ->nullable();
            $table->enum('activity_at_destination', ActivityLevels::values())
                ->nullable();
            $table->integer('trade_volume_at_destination')
                ->nullable();
            $table->enum('origin_type', TradeGoodTypes::values())
                ->nullable();
            $table->enum('destination_type', TradeGoodTypes::values())
                ->nullable();
